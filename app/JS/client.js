...
var quizManager = /** @class */ (function () {
    ...
    quizManager.prototype.getChampInfo = function () {
        var _this = this;
        var url = "http://ddragon.leagueoflegends.com/cdn/12.9.1/data/en_US/champion.json";
        fetch(url)
    ...
    quizManager.prototype.setPlayButtonListener = function () {
        var _this = this;
        var _a;
        (_a = document.querySelector(".playButton")) === null || _a === void 0 ? void 0 : _a.addEventListener("click", function (e) {
